        ...
        <div class="bg-wrapper">
            <div class="container">
                ...
                <div class="card-one shapes bg-white wow fadeInRight">
                    ...
                    <h6 class="fw-500 tx-dark mb-15">Save up to 50% in Yearly plan.</h6>
                    <a href="#" class="more-btn tran3s text-uppercase fw-500 fs-13">Learn MORe</a>
                </div>
                <div class="illustration-holder">
                    <img src="images/lazy.svg" data-src="images/assets/ils_01.png" alt="" class="lazy-img main-illustration w-100">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 wow fadeInLeft">
                    <div class="title-style-one text-center text-lg-start">
                        <h2 class="main-title fw-bold tx-dark m0">Provide <span>Quality</span> Services.</h2>
                    </div> <!-- /.title-style-one -->
                </div>
                <div class="col-lg-5 ms-auto wow fadeInRight">
                    <p class="text-lg text-center text-lg-start md-pt-30 m0">Jano provides alternative asset management solutions to a global client base and manages a significant.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-xxl-5">
                <div class="col-lg-3 col-sm-6 wow fadeInUp">
                    <div class="card-style-one pe-xxl-5 position-relative mt-40">
                        ...
                        <h5 class="fw-500 mt-35 mb-25"><a href="service-details.html" class="tran3s tx-dark">Quality Design <br> Maker.</a></h5>
                        <p class="mb-25">The core of our service is based on the objective investment advice we seek to provide supported.</p>
                        <a href="service-details.html"><img src="images/lazy.svg" data-src="images/icon/icon_05.svg" alt="" class="lazy-img"></a>
                    </div> <!-- /.card-style-one -->
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card-style-one pe-xxl-5 position-relative mt-40">
                        ...
                        <h5 class="fw-500 mt-35 mb-25"><a href="service-details.html" class="tran3s tx-dark">Proffesional Support <br>by expert.</a></h5>
                        <p class="mb-25">Through our Family Office Services, we are able to provide the expertise derived from our beginnings.</p>
                        <a href="service-details.html"><img src="images/lazy.svg" data-src="images/icon/icon_05.svg" alt="" class="lazy-img"></a>
                    </div> <!-- /.card-style-one -->
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-style-one pe-xxl-5 position-relative mt-40">
                        ...
                        <h5 class="fw-500 mt-35 mb-25"><a href="service-details.html" class="tran3s tx-dark">Marketing & Affiliate <br> Services.</a></h5>
                        <p class="mb-25">Capco’s response is proven by our superb record of driving change through effective portfolio.</p>
                        <a href="service-details.html"><img src="images/lazy.svg" data-src="images/icon/icon_05.svg" alt="" class="lazy-img"></a>
                    </div> <!-- /.card-style-one -->
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="card-style-one pe-xxl-5 position-relative mt-40">
                        ...
                        <h5 class="fw-500 mt-35 mb-25"><a href="service-details.html" class="tran3s tx-dark">Cross Browser <br>Optimized.</a></h5>
                        <p class="mb-25">The core of our service is based on the objective investment advice we seek to provide supported.</p>
                        <a href="service-details.html"><img src="images/lazy.svg" data-src="images/icon/icon_05.svg" alt="" class="lazy-img"></a>
                    </div> <!-- /.card-style-one -->
                </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 ms-auto order-md-last">
                    <div class="block-style-one pt-35 wow fadeInRight">
                        <div class="title-style-one">
                            <div class="sc-title text-uppercase">About us</div>
                            <h2 class="main-title fw-bold tx-dark m0">Your Comfort is Our <span>Priority</span></h2>
                        </div> <!-- /.title-style-one -->
                        <p class="text-lg tx-dark pt-35 pb-40 lg-pb-20">Some hardworking people are working day and night to provide scalable product. </p>
                    ...
                    <a href="about-v3.html" class="more-btn tran3s fw-500 fs-18 wow fadeInUp">Discover More <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="col-md-6 order-md-first wow fadeInLeft">
                    <div class="img-meta d-inline-block position-relative ps-3 ps-lg-5 pb-50 md-mt-50 sm-mt-80">
                        <img src="images/lazy.svg" data-src="images/media/img_01.jpg" alt="" class="lazy-img">
                        ...
                        <div class="card-one wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="name fs-18 fw-500 tx-dark mb-10">- Rashed Ka, <span class="opacity-50">CEO</span></div>
                            <p class="fs-18 m0">We aim to answer any quis query in less than</p>
                        </div> <!-- /.card-one -->
                    </div> <!-- /.img-meta -->
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7">
                        <div class="title-style-one text-center text-md-start">
                            <h2 class="main-title fw-bold tx-dark m0">What’s <span>Our Client</span> Say About us.</h2>
                        </div> <!-- /.title-style-one -->
                    </div>
                    ...
                    <div class="item">
                        <div class="feedback-block-one pt-45 align-items-end d-sm-flex">
                            ...
                            <div class="text-wrapper">
                                ...
                                <h6>Martin Jonas, <span class="opacity-25">USA</span></h6>
                            </div> <!-- /.text-wrapper -->
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 ms-auto order-lg-last">
                    <div class="block-style-one md-mb-60 wow fadeInRight">
                        <div class="title-style-one">
                            <h2 class="main-title fw-bold tx-dark m0">We working with <span>knowledge,</span><br> skills all of heart & soul.</h2>
                        </div> <!-- /.title-style-one -->
                        <p class="text-lg pt-60 pb-60 lg-pt-30 lg-pb-30">Auis nostrud exercitation ullamco labors nis slit alquip Duis aute irure dolor in reprehen erio isu voluptate velit sed.</p>
                        <div class="name fs-20 tx-dark fw-500">- Rashed Kabir, <span class="opacity-25">CEO Janu</span></div>
                    </div> <!-- /.block-style-one -->
                </div>
                <div class="col-xl-6 col-lg-5 col-md-8 col-sm-10 order-lg-first wow fadeInLeft">
                    <div class="img-meta-two d-inline-block position-relative pb-50">
                        <img src="images/lazy.svg" data-src="images/media/img_04.jpg" alt="" class="lazy-img rounded-3">
                        ...
                        <div class="card-one wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <h5 class="fw-500 m0">Expert talkign with cusomter.</h5>
                        </div> <!-- /.card-one -->
                    </div> <!-- /.img-meta-two -->
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp">
                    <div class="card-style-two mt-40">
                        ...
                        <span class="d-inline-block text-uppercase fs-14 opacity-75 mt-30 mb-10">Quality Design</span>
                        <h4 class="fw-500 m0">We do focus on quality not quantity.</h4>
                    </div> <!-- /.card-style-two -->
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-style-two mt-40">
                        ...
                        <span class="d-inline-block text-uppercase fs-14 opacity-75 mt-30 mb-10">Expert Support</span>
                        <h4 class="fw-500 m0">Expert ready to help you anytime.</h4>
                    </div> <!-- /.card-style-two -->
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="card-style-two mt-40">
                        ...
                        <span class="d-inline-block text-uppercase fs-14 opacity-75 mt-30 mb-10">Mobile Friendly</span>
                        <h4 class="fw-500 m0">All design compitable with mobile.</h4>
                    </div> <!-- /.card-style-two -->
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-7">
                        <div class="title-style-one text-center text-sm-start xs-mb-30">
                            <h2 class="main-title fw-bold tx-dark m0">Inside <span>story</span> of our company.</h2>
                        </div> <!-- /.title-style-one -->
                    </div>
                    <div class="col-lg-6 col-sm-5 ms-auto d-flex justify-content-center justify-content-sm-end">
                        <a href="blog-v1.html" class="btn-one fw-500">Go to Blog</a>
                    </div>
                </div>
                ...
                <div class="row pt-50 lg-pt-30">
                    <div class="col-lg-4 col-sm-6 d-flex wow fadeInUp">
                        <article class="blog-meta-one tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_01.jpg" alt="" class="lazy-img w-100 tran4s"></a></figure>
                            <div class="post-data mt-25">
                                <a href="blog-details.html" class="post-tag fw-500 tx-dark text-uppercase mb-20" style="background-color: #FFEAC9;">Technology</a>
                                <a href="blog-details.html" class="blog-title d-block"><h4 class="tran3s">A Discount Cartridge dsu is Better Ever.</h4></a>
                                <a href="blog-details.html" class="read-btn mt-35"><img src="images/lazy.svg" data-src="images/icon/icon_12.svg" alt="" class="lazy-img"></a>
                            </div> <!-- /.post-data -->
                        </article> <!-- /.blog-meta-one -->
                    </div>
                    <div class="col-lg-4 col-sm-6 d-flex wow fadeInUp" data-wow-delay="0.1s">
                        <article class="blog-meta-one tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_02.jpg" alt="" class="lazy-img w-100 tran4s"></a></figure>
                            <div class="post-data mt-25">
                                <a href="blog-details.html" class="post-tag fw-500 tx-dark text-uppercase mb-20" style="background-color: #CEEBF4;">Design</a>
                                <a href="blog-details.html" class="blog-title d-block"><h4 class="tran3s">Good design is the key of business.</h4></a>
                                <a href="blog-details.html" class="read-btn mt-35"><img src="images/lazy.svg" data-src="images/icon/icon_12.svg" alt="" class="lazy-img"></a>
                            </div> <!-- /.post-data -->
                        </article> <!-- /.blog-meta-one -->
                    </div>
                    <div class="col-lg-4 col-sm-6 d-flex wow fadeInUp" data-wow-delay="0.2s">
                        <article class="blog-meta-one tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_03.jpg" alt="" class="lazy-img w-100 tran4s"></a></figure>
                            <div class="post-data mt-25">
                                <a href="blog-details.html" class="post-tag fw-500 tx-dark text-uppercase mb-20" style="background-color: #FFDFDF;">Support</a>
                                <a href="blog-details.html" class="blog-title d-block"><h4 class="tran3s">Client satisfaction is the goal of business success.</h4></a>
                                <a href="blog-details.html" class="read-btn mt-35"><img src="images/lazy.svg" data-src="images/icon/icon_12.svg" alt="" class="lazy-img"></a>
                            </div> <!-- /.post-data -->
                        </article> <!-- /.blog-meta-one -->
                    </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-10 m-auto text-center">
                    <div class="title-style-one wow fadeInUp">
                        <h2 class="main-title fw-bold tx-dark m0">Ready to take plan? It’s just a matter of <span>one clike</span></h2>
                    </div> <!-- /.title-style-one -->
                    <p class="text-lg tx-dark pt-40 pb-35 lg-pt-30 lg-pb-20 wow fadeInUp" data-wow-delay="0.1s">Try it risk free — we don’t charge cancellation fees.</p>
                    <a href="#" class="btn-two fs-18 fw-500 wow fadeInUp" data-wow-delay="0.2s">Purchase Now</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-6">
                                <div class="title-style-two">
                                    <div class="sc-title fw-500 ">Subscirbe Now</div>
                                    <h4 class="main-title fw-bold tx-dark">New user? Start your free trial now.</h4>
                                </div> <!-- /.title-style-two -->
                            </div>
                            <div class="col-lg-6">
                                <div class="subscribe-form">
                                    ...
                                    <p class="m0 pt-10">Already a member? <a href="#" class="tx-dark">Sign in.</a></p>
                                </div> <!-- /.subscribe-form -->
                            </div>
                        </div>
                    </div> <!-- /.subscribe-area -->
